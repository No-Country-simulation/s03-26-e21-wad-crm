...
<<<<<<< HEAD:server/src/test/java/com/crm/module/auth/service/AuthServiceTest.java
import com.crm.module.user.entity.UserRole;
=======
>>>>>>> origin/feat/startup-crm/whatsapp:server/src/test/java.disabled/com/crm/module/auth/service/AuthServiceTest.java
...
class AuthServiceTest {
    ...
    void setUp() {
        ...
        user = User.builder()
                ...
                .name("Test User")
<<<<<<< HEAD:server/src/test/java/com/crm/module/auth/service/AuthServiceTest.java
                .role(Role.builder().name("ADMIN").permissions("read,write").isSystem(true).isActive(true).build())
=======
