...
Las skills se auto-cargan según el contexto detected. Están en `setup-ai-skills/skills/`.
...
| go-testing | Tests en Go | Go testing patterns |
...
/sdd-new contacts-api        → Explore + Propose
/sdd-ff contacts-api         → Fast-forward: propose → spec → design → tasks
